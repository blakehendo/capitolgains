...
Capitol Gains is an x402 congressional trade data API. It turns public U.S. Senate trade disclosures into a clean JSON endpoint, with x402 handling per-request payment and Supabase serving a cache-backed API contract.
